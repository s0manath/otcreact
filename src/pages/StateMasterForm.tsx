  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] p-8 lg:p-12 font-sans">
      <div className="max-w-4xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-12">
          ...
          >
            ...
            <h1 className="text-4xl font-black text-slate-900 tracking-tight leading-none mb-4">
              {isEdit ? "Refine" : "Add"}{" "}
              <span className="text-orange-600 px-2 py-1 bg-orange-50 rounded-2xl">
                State Node.
              </span>
            </h1>
          </motion.div>
        ...
        <form
          onSubmit={handleSave}
          className="bg-white rounded-[2.5rem] border border-slate-200 shadow-xl p-10 space-y-8"
        >
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <select
                  value={form.regionId || ""}
                  onChange={(e) =>
                    setForm({ ...form, regionName: e.target.value })
                  }
          ...
          <div className="flex items-center gap-4 pt-4 border-t border-slate-100">
            <div className="flex-1">
              ...
              <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                Control if this state is selectable in other modules
              </p>
            </div>
            <button
              type="button"
            ...
            >
              <div
                className={`absolute top-1 w-6 h-6 bg-white rounded-full shadow-sm transition-all ${form.isActive ? "left-7" : "left-1"}`}
              />
            </button>
          </div>
