...
import masterService, { type CustodianMaster, type MasterDropdownItem } from '../services/masterService';
    ...
    if (loading) {
        return (
            <div className="min-h-screen bg-[#f8fafc] flex flex-col items-center justify-center gap-4">
                ...
                <p className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">Loading Entity Data...</p>
            </div>
        );
    }
    ...
    return (
        <div className="min-h-screen bg-[#f8fafc] p-8 lg:p-12 font-sans selection:bg-primary-500/30">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-12 relative">
                    ...
                    >
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            >
                                <ArrowLeft size={14} className="text-slate-400 group-hover:text-primary-500 transition-colors" />
                                <span className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 group-hover:text-primary-600">Back to Analytics</span>
                            </button>
                        </div>
                        <h1 className="text-4xl lg:text-5xl font-black text-slate-900 tracking-tight leading-none mb-4">
                            {isEdit ? 'Refine' : 'Initialize'} <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-indigo-600">Custodian Profile.</span>
                        </h1>
                        <p className="text-slate-500 font-bold text-lg max-w-xl">
                            {isEdit ? `Updating operational credentials for: ${form.custodianName}` : 'Establish a new field operative within the central management node.'}
                        </p>
                    </motion.div>
                ...
                <form onSubmit={handleSave} className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div className="lg:col-span-7 space-y-8">
                        ...
                        >
                            <div className="flex items-center gap-4 mb-10">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Step 01 / Basic Data</p>
                                </div>
                            </div>

                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-slate-500 ml-1">Operative Name</label>
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-slate-500 ml-1">Contact Link (Mobile)</label>
                                    <div className="group/input relative">
                                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-300 group-focus-within/input:text-primary-500 transition-colors">
                                            <Phone size={18} />
                                        </div>
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-slate-500 ml-1">Digital Protocol (Email)</label>
                                    <div className="group/input relative">
                                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-300 group-focus-within/input:text-primary-500 transition-colors">
                                            <Mail size={18} />
                                        </div>
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-slate-500 ml-1">Terminal Link (UUID)</label>
                                    <div className="group/input relative">
                                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-300 group-focus-within/input:text-primary-500 transition-colors">
                                            <Shield size={18} />
                                        </div>
                                        <input
                                            type="text"
                                            value={form.iemiNo}
                                            onChange={e => setForm({ ...form, iemiNo: e.target.value })}
                                            className="w-full bg-slate-50 border border-slate-200 rounded-2xl py-4 pl-12 pr-4 text-sm font-bold text-slate-800 focus:outline-none focus:ring-4 focus:ring-primary-500/5 focus:border-primary-400 transition-all placeholder:text-slate-300"
                        ...
                        >
                            <div className="flex items-center gap-4 mb-10">
                                ...
                                <div>
                                    <h3 className="text-sm font-black text-slate-900 uppercase tracking-widest">Node Associations</h3>
                                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Step 02 / Territory</p>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-slate-500 ml-1">Zone Manager</label>
                                    <div className="relative">
                                        <select
                                            value={form.zomId || ''}
                                            onChange={e => setForm({ ...form, zomId: parseInt(e.target.value) })}
                                            className="w-full bg-slate-50 border border-slate-200 rounded-2xl py-4 px-4 text-sm font-bold text-slate-800 focus:outline-none focus:ring-4 focus:ring-primary-500/5 focus:border-primary-400 transition-all appearance-none"
                                        >
                                            <option value="">Select ZOM</option>
                                            {zoms.map(zom => (
                                                <option key={zom.id} value={zom.id}>{zom.name}</option>
                                            ))}
                                        </select>
                                        <div className="absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none text-slate-400">
                                            <ChevronRight size={14} className="rotate-90" />
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-slate-500 ml-1">Route Key Selection (Helper)</label>
                                    <div className="relative">
                                        <select
                                            onChange={e => {
                                                ...
                                                setForm({ ...form, custodianCode: cid, touchKeyId: tk });
                                            }}
                                            className="w-full bg-slate-50 border border-slate-200 rounded-2xl py-4 px-4 text-sm font-bold text-slate-800 focus:outline-none focus:ring-4 focus:ring-primary-500/5 focus:border-primary-400 transition-all appearance-none"
                                        >
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-slate-500 ml-1">Parent Franchise</label>
                                    <div className="relative">
                                        <select
                                            value={form.franchiseId || ''}
                                            onChange={e => setForm({ ...form, franchiseId: parseInt(e.target.value) })}
                                            className="w-full bg-slate-50 border border-slate-200 rounded-2xl py-4 px-4 text-sm font-bold text-slate-800 focus:outline-none focus:ring-4 focus:ring-primary-500/5 focus:border-primary-400 transition-all appearance-none"
                                        >
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-slate-500 ml-1">Operative ID (CID)</label>
                                    <div className="group/input relative">
                                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-300 group-focus-within/input:text-primary-500 transition-colors">
                                            <Shield size={18} />
                                        </div>
                                        <input
                                            ...
                                            onChange={e => setForm({ ...form, custodianCode: e.target.value })}
                                            className="w-full bg-slate-50 border border-slate-200 rounded-2xl py-4 pl-12 pr-4 text-sm font-bold text-slate-800 focus:outline-none focus:ring-4 focus:ring-primary-500/5 focus:border-primary-400 transition-all placeholder:text-slate-300"
                    ...
                    <div className="lg:col-span-5 space-y-8">
                        ...
                        >
                            <div className="flex items-center gap-4 mb-10">
                                ...
                                <div>
                                    <h3 className="text-sm font-black text-slate-900 uppercase tracking-widest">Digital Auth Tools</h3>
                                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Step 03 / Hardware & Time</p>
                                </div>
                            </div>

                            <div className="space-y-8 flex-1">
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-slate-500 ml-1">Hardware ID (Touch Key)</label>
                                    <div className="group/input relative">
                                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-300 group-focus-within/input:text-primary-500 transition-colors">
                                            <Key size={18} />
                                        </div>
                                        <input
                                            ...
                                            onChange={e => setForm({ ...form, touchKeyId: e.target.value })}
                                            className="w-full bg-slate-50 border border-slate-200 rounded-2xl py-4 pl-12 pr-4 text-sm font-bold text-slate-800 focus:outline-none focus:ring-4 focus:ring-primary-500/5 focus:border-primary-400 transition-all placeholder:text-slate-300"
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-slate-100">
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-black uppercase tracking-widest text-slate-500 ml-1">Access Start</label>
                                        <div className="group/input relative">
                                            <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-300 group-focus-within/input:text-primary-500 transition-colors">
                                                <Clock size={16} />
                                            </div>
                                            <input
                                                ...
                                                onChange={e => setForm({ ...form, accessFrom: e.target.value })}
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-black uppercase tracking-widest text-slate-500 ml-1">Access Termination</label>
                                        <div className="group/input relative">
                                            <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-300 group-focus-within/input:text-primary-500 transition-colors">
                                                <Clock size={16} />
                                            </div>
                                            <input
                                                type="datetime-local"
                                                value={form.accessTo}
                                                onChange={e => setForm({ ...form, accessTo: e.target.value })}
                                                className="w-full bg-slate-50 border border-slate-200 rounded-2xl py-4 pl-12 pr-4 text-[10px] font-black text-slate-800 focus:outline-none focus:ring-4 focus:ring-primary-500/5 focus:border-primary-400 transition-all"
                                            />
                                        </div>
                                    </div>
                                ...
                                <div className="pt-8 border-t border-slate-100">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-slate-500 ml-1 mb-4 block">Visual Profile</label>
                                    <div className="flex items-center gap-6">
                                        <div className="w-24 h-24 rounded-3xl bg-slate-50 border border-slate-200 flex flex-col items-center justify-center relative overflow-hidden group transition-all hover:border-primary-300 shadow-inner">
                                            ...
                                            <input type="file" className="absolute inset-0 opacity-0 cursor-pointer" title="Upload operater photo" />
                                        </div>
                                        <div>
                                            <h4 className="text-xs font-black text-slate-800 uppercase tracking-widest">Biometric Photo</h4>
                                            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">PNG/JPG up to 2MB</p>
                                            <div className="flex gap-4 mt-3">
                                                <button type="button" className="text-[10px] font-black text-primary-600 uppercase tracking-widest hover:text-primary-700">Update</button>
                                                <button type="button" className="text-[10px] font-black text-rose-500 uppercase tracking-widest hover:text-rose-600">Delete</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
