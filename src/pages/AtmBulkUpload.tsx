        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-12 relative">
          ...
          >
            ...
            <h1 className="text-4xl lg:text-5xl font-black text-slate-900 tracking-tight leading-none mb-4">
              Bulk <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-indigo-600 text-6xl">
                Initialization.
              </span>
            </h1>
            <p className="text-slate-500 font-bold text-lg max-w-xl">
              Synchronize multiple terminal nodes via standard Excel protocol.
              Validate hierarchy and connectivity in real-time.
            </p>
          </motion.div>
                  ...
                  {file ? (
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-slate-400 font-bold mb-8">
                        Select .xlsx or .xls file containing ATM node
                        descriptors
                      </p>
                      <button
                ...
                <div className="relative z-10 flex flex-col">
                  ...
                  {result.errors.length > 0 && (
                    <div className="space-y-4">
                      <h4 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] italic ml-1 mb-4">
                        Conflict Logs
                      </h4>
