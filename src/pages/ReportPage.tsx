...
> = {
  scheduled: {
    title: "Scheduled Details Report",
    subtitle: "Operations / Resource Planning",
    icon: Calendar,
  },
  "route-details": {
    title: "Route Mapped Report",
    subtitle: "Logistics / Fleet Overview",
    icon: FileText,
  },
  "otc-checkout": {
    title: "OTC Checkout Report",
    subtitle: "Operations / Compliance",
    icon: FileText,
  },
  "otc-activity": {
    title: "OTC Activity Detail Report",
    subtitle: "Audit / Performance",
    icon: RefreshCcw,
  },
  audit: {
    title: "Audit Logs Report",
    subtitle: "Security / Traceability",
    icon: FileText,
  },
  "atm-detail": {
    title: "ATM Detail Report",
    subtitle: "Inventory / Asset Registry",
    icon: FileText,
  },
  "custodian-wise": {
    title: "Custodian Wise Report",
    subtitle: "Performance / Analytics",
    icon: RefreshCcw,
  },
  "otc-reset": {
    title: "OTC Reset Report",
...
const ReportPage: React.FC = () => {
  ...
  const info = REPORT_INFO[reportKey] || {
    title: "System Report",
  ...
  const handleExport = async () => {
    ...
    ========================= */
      alert(
        `Dataset too large for browser Excel (${totalRows} rows). Switching to backend secure download...`,
      );
