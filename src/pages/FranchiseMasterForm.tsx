...
import masterService, { type FranchiseMaster, type MasterDropdownItem } from '../services/masterService';
    ...
    if (loading) {
        return (
            <div className="min-h-screen bg-[#f8fafc] flex flex-col items-center justify-center gap-4">
                ...
                <p className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">Loading Node Data...</p>
            </div>
        );
    }
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-12 relative">
                    ...
                    >
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            >
                                <ArrowLeft size={14} className="text-slate-400 group-hover:text-indigo-500 transition-colors" />
                                <span className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 group-hover:text-indigo-600">Franchise Inventory</span>
                            </button>
                        </div>
                        <h1 className="text-4xl lg:text-5xl font-black text-slate-900 tracking-tight leading-none mb-4">
                            ...
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600">Regional Franchise.</span>
                        </h1>
                        <p className="text-slate-500 font-bold text-lg max-w-xl">
                            {isEdit ? `Updating organizational parameters for: ${form.franchiseName}` : 'Establish a new regional node to expand operational jurisdiction.'}
                        </p>
                    </motion.div>
                    ...
                    >
                        <span className="text-xs font-black uppercase tracking-widest" title="Exit without saving">Discard</span>
                        <X size={20} />
                    </motion.button>
                </div>
                    ...
                    <div className="lg:col-span-8 space-y-8">
                        ...
                        >
                            <div className="flex items-center gap-4 mb-10">
                                ...
                                <div>
                                    <h3 className="text-sm font-black text-slate-900 uppercase tracking-widest">Organization Profile</h3>
                                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Step 01 / Legal Entity</p>
                                </div>
                            </div>

                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                                <div className="md:col-span-2 space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-slate-500 ml-1">Franchise Designation</label>
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-slate-500 ml-1">SAP ERP Code</label>
                                    <div className="group/input relative">
                                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-300 group-focus-within/input:text-indigo-500 transition-colors">
                                            <Hash size={18} />
                                        </div>
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-slate-500 ml-1">Official Hotline</label>
                                    <div className="group/input relative">
                                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-300 group-focus-within/input:text-indigo-500 transition-colors">
                                            <Phone size={18} />
                                        </div>
                        ...
                        >
                            <div className="flex items-center gap-4 mb-10">
                                ...
                                <div>
                                    <h3 className="text-sm font-black text-slate-900 uppercase tracking-widest">Jurisdictional Mapping</h3>
                                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Step 02 / Geography</p>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-slate-500 ml-1">District Node</label>
                                    <div className="relative">
                                        <select
                                            value={form.districtId || ''}
                                            onChange={e => setForm({ ...form, districtId: parseInt(e.target.value) })}
                    ...
                    <div className="lg:col-span-4 space-y-8">
                        ...
                        >
                            <div className="flex items-center gap-4 mb-10">
                                ...
                                <div>
                                    <h3 className="text-sm font-black text-slate-900 uppercase tracking-widest">Logic Control</h3>
                                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Step 03 / Protocol & State</p>
                                </div>
                            </div>

                            <div className="space-y-6 flex-1">
                                <div
                                    onClick={() => setForm({ ...form, secondaryCustodianRequire: !form.secondaryCustodianRequire })}
                                    className={`p-6 rounded-3xl border cursor-pointer transition-all flex flex-col gap-4 group ${form.secondaryCustodianRequire
                                        ? 'bg-amber-50 border-amber-200 shadow-inner'
                                        : 'bg-white border-slate-100 hover:border-amber-200 hover:bg-amber-50/30'
                                        }`}
                                >
                                    <div className="flex items-center justify-between">
                                        <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${form.secondaryCustodianRequire ? 'bg-amber-500 text-white' : 'bg-slate-100 text-slate-400 group-hover:text-amber-500'}`}>
                                            <Users size={20} />
                                        </div>
                                        {form.secondaryCustodianRequire && <CheckCircle2 size={16} className="text-amber-500" />}
                                    </div>
                                    <div>
                                        <div className="text-xs font-black text-slate-900 uppercase tracking-widest">Dual-Auth Mode</div>
                                        <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">Requires secondary custodian signature</p>
                                    </div>
                                </div>

                                <div
                                    onClick={() => setForm({ ...form, isActive: !form.isActive })}
                                    className={`p-6 rounded-3xl border cursor-pointer transition-all flex flex-col gap-4 group ${form.isActive
                                ...
                                >
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className={`w-10 h-5 rounded-full relative transition-all ${form.isActive ? 'bg-emerald-200' : 'bg-rose-200'}`}>
                                            <div className={`absolute top-1 w-3 h-3 bg-white rounded-full shadow-sm transition-all ${form.isActive ? 'right-1' : 'left-1'}`} />
                                        </div>
                                    </div>
                                    <div>
                                        <div className="text-xs font-black text-slate-900 uppercase tracking-widest">Operational State</div>
                                        <p className={`text-[10px] font-bold uppercase tracking-widest mt-1 ${form.isActive ? 'text-emerald-600' : 'text-rose-600'}`}>
                                            {form.isActive ? 'Live / Distributed' : 'Offline / Restricted'}
                                        </p>
                                    </div>
                                </div>
                            </div>
